...
/// (T-032's heat toggle) can join this row without inventing shared chrome
/// for it to sit inside. Carries the search button (search-quick-filters
/// TRD §11 C6) and the profile/Passport button (passport TRD §11 C7)
/// today; the row itself adds no background, no border, nothing that
/// groups buttons that don't belong together.
///
